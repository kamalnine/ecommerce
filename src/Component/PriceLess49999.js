...
function PriceLess49999({cart,setCart}) {
    ...
    function fetchProductBy49999() {
      try {
        fetch('https://localhost:7131/api/Product/GetProductsByPriceLessThan49999',{
          // headers:{
