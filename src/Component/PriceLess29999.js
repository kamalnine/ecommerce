...
function PriceLess29999({cart,setCart}) {
    ...
    function fetchProductBy29999() {
      try {
        fetch('https://localhost:7131/api/Product/GetProductsByPriceLessThan29999',{
          // headers:{
