...
function PriceLess69999({cart,setCart}) {
    ...
    function fetchProductBy69999() {
      try {
        fetch('https://localhost:7131/api/Product/GetProductsByPriceLessThan69999',{
          // headers:{
