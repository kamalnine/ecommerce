...
function PriceLess89999({cart,setCart}) {
    ...
    function fetchProductBy89999() {
      try {
        fetch('https://localhost:7131/api/Product/GetProductsByPriceLessThan89999',{
          // headers:{
