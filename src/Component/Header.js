                 ...
                 <ul className="navbar-nav" style={{ display: 'flex', flexDirection: 'row', gap: '130px', marginTop: "-15px" }}>
                     <li className="nav-item dropdown" >
                         <NavDropdown title="Electronics" id="navbarDropdown">
                             <NavDropdown.Item as={Link} to="/adminMobile">Mobiles</NavDropdown.Item>
                             <NavDropdown.Item as={Link} to="/adminLaptop">Laptops</NavDropdown.Item>
                             <NavDropdown.Item as={Link} to="/adminTablet">Tablets</NavDropdown.Item>
                         </NavDropdown>
                     </li>
                     <li className="nav-item dropdown">
                         <NavDropdown title="Clothing, Shoes & Jewelry" id="navbarDropdown2">
                             <NavDropdown.Item as={Link} to="/adminClothes">Clothes</NavDropdown.Item>
                             <NavDropdown.Item as={Link} to="/adminShoes">Shoes</NavDropdown.Item>
                             <NavDropdown.Item as={Link} to="/adminGold">Jewelry</NavDropdown.Item>
                         </NavDropdown>
                     </li>
                     <li className="nav-item" style={{ color: "white" }}>
                         <NavLink to="/adminBooks" className="nav-link text-light" >
                             Books
                         </NavLink>
                     </li>
                     <li className="nav-item" style={{ color: "white" }}>
                         <NavLink to="/adminHomeAppliances" className="nav-link text-light">
                             Home & Kitchen
                         </NavLink>
                     </li>
